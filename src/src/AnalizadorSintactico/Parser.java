...
//#line 60 ".\gramatica.y"
                ...
                case 39:
//#line 69 ".\gramatica.y"
                {System.out.println("ERROR EN SENTENCIA DE FUNCION. Linea: " + al.getLinea() + " se esperaba ','");}
                break;
                case 40:
//#line 70 ".\gramatica.y"
                {System.out.println("ERROR EN SENTENCIA DE FUNCION. Linea: " + al.getLinea() + " se esperaba ','");}
...
//#line 81 ".\gramatica.y"
                ...
                case 54:
//#line 90 ".\gramatica.y"
                {System.out.println("ERROR EN SENTENCIA DE CLASE. Linea: " + al.getLinea() + " se esperaba ','");}
                break;
                case 55:
//#line 91 ".\gramatica.y"
                {System.out.println("ERROR EN SENTENCIA DE CLASE. Linea: " + al.getLinea() + " se esperaba ','");}
